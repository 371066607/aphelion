...
开新档或一颗星第一次着陆时，从一张群系砖表观测出格网。家园是迫降点群系，只观测一次；星球格网写入星球存档，再登陆读旧图。五种群系五张表。水是砖，湖不是保证。出发必须选已知星或未知新星；图鉴只读。观测失败则降级。游戏里的坍缩只留给累塌。详见 `docs/adr/0036-observation-and-biome-tile-tables.md`。
