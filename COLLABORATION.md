...
| 人 | 做过的票 | 进行中 | 备注 |
|---|---|---|---|
| **371066607 / Rain** | #59-#63 俯卧全套 / #66 睡觉 / #67 累塌 / #68 居民俯卧 / #70 医疗舱 / #71 击倒叠伤 / #72 送医（已关） | — | git 署名 `Rain <rain@kirin-media.com>` 与 GitHub 账号同一人 |
| **da123wda**（git 署名 wen_king） | #60 脸0俯卧图 / #64 生病走慢（已合入，已关） | — | 分支 `issue-60-face0-prone-sheet` 已 merge |
| **另一终端** | #65 粮边吃（已提交 82c3859） | — | 用户另一个终端在改，勿重复 |

**当前避开区**：暂无。剩 #69 病重居民躺医疗舱（blocker #58+#66 已关，可做但需先确认与 #64 生病区的交集）。
