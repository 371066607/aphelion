...
| 人 | 做过的票 | 进行中 | 备注 |
|---|---|---|---|
| **371066607 / Rain** | #59-#72 / 建筑 v3 / 天气 / 架构重构 4 期（#108-#127） / 人际网络（#128-#132） / 仓储物流（#133-#137） / 远征遗迹（#138-#142） / 温度系统（#143-#147） / 视觉资产补票（#148-#150） | — | git 署名 `Rain <rain@kirin-media.com>` 与 GitHub 账号同一人 |
