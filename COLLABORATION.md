...
| 人 | 做过的票 | 进行中 | 备注 |
|---|---|---|---|
| **371066607 / Rain** | #59 俯卧 / #66 睡觉 / #67 累塌 / #72 送医 / #70 医疗舱躺（已关） | — | git 署名 `Rain <rain@kirin-media.com>` 与 GitHub 账号同一人 |
| **da123wda**（git 署名 wen_king） | #60 脸0俯卧图 / #64 生病走慢（已合入 main，已关） | — | 分支 `issue-60-face0-prone-sheet` 已 merge |

**当前避开区**：暂无。生病相关改动已可碰（#64 已合入）。
