...
- [ ] **T1** 环境气温与房间热阻传导模型 (#144)：`ambientTemperatureOf` + 房间热阻传导 + HUD 天气行温度显示
- [ ] **T2** 电暖器与制冷空调温控电器建筑 (#145)：`bl_heater` (40W) + `bl_cooler` (50W) 接入实体电网与目标控温
- [ ] **T3** 冷冻冷库食物永久保鲜与温室防冻 (#146)：<0°C 食物腐烂锁零永久保鲜 + 作物适温生长与冻害减产
- [ ] **T4** 失温与中暑生理机制及全场景冒烟闭环 (#147)：失温/中暑累积与消退 + 防寒服拓展至-35°C + 虚脱击倒与全链路冒烟
