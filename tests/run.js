...
for (const f of ['config.js', 'utils.js','observe.js','entity_index.js', 'world_runtime.js', 'terrain_model.js', 'build_grid.js','scene.js','camera.js', 'input.js', 'humanoid.js', 'save.js', 'opening.js', 'planet.js', 'combat.js', 'entities.js', 'colony.js', 'construction.js','recovery.js','home_progress.js', 'logistics.js','production_jobs.js','storage.js', 'rivals.js', 'events.js', 'nav.js', 'weather.js', 'residents.js','ecology.js', 'expedition_state.js', 'alerts.js', 'visitors.js', 'colonytick.js', 'draw.js', 'sprites.js', 'llm.js', 'hints.js']) {
