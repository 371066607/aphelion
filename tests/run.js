...
for (const f of ['config.js', 'utils.js','atlas.js','observe.js','entity_index.js', 'world_runtime.js', 'terrain_model.js', 'build_grid.js','scene.js','camera.js', 'input.js', 'humanoid.js', 'planet.js', 'save.js', 'opening.js', 'combat.js', 'entities.js', 'colony.js', 'construction.js','recovery.js','home_progress.js', 'logistics.js','production_jobs.js','storage.js', 'rivals.js', 'events.js', 'nav.js', 'weather.js', 'residents.js','ecology.js', 'expedition_state.js', 'alerts.js', 'visitors.js', 'resident_work.js', 'colonytick.js', 'draw.js', 'sprites.js', 'llm.js', 'hints.js']) {
